...
type BindingValue =
  ...
  | {sourceType: 'legacyConditional'}
  | {sourceType: 'legacy'};

type SettingValue = StaticPropValue | BindingValue;

type UnsupportedBindingValue =
  | {sourceType: 'conditional'}
  | {sourceType: 'legacyConditional'}
  | {sourceType: 'legacy'};

type InstancePropSummaryBindingValue = BindingInput | UnsupportedBindingValue;
...
interface InstancePropSummary {
  propId: string;
  value: ResolvedValue | InstancePropSummaryBindingValue | null;
  hasOverride: boolean;
}
