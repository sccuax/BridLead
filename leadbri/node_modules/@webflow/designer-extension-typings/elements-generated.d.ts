...
interface WebflowElement {
  ...
  getParentComponent(this: {id: FullElementId}): Promise<AnyComponent | null>;
}
...
interface ComponentElement
  ...
  getComponent(): Promise<AnyComponent>;
...
interface DynamoWrapperElement
  ...
  getSettings(): Promise<CollectionListSettings>;
  setSettings(settings: CollectionListSetSettingsInput): Promise<null>;
  setSettings(
    this: {id: FullElementId},
    settings: SetSettingsInput
  ): Promise<null>;
  searchAvailableSources(): Promise<Array<CollectionListAvailableSource>>;
  searchAvailableFields(): Promise<Array<CollectionListAvailableField>>;
  searchAvailableItems(
    options?: SearchAvailableItemsOptions
  ): Promise<SearchAvailableItemsResult>;
}
